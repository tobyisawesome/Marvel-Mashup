...
public class MjolnirItem extends MarvelMashupModElements.ModElement {
	@ObjectHolder("marvel_mashup:mjolnir")
	public static final Item block = null;
	public MjolnirItem(MarvelMashupModElements instance) {
		super(instance, 2);
	}
		...
		elements.items.add(() -> new ItemToolCustom() {
			...
			public void inventoryTick(ItemStack itemstack, World world, Entity entity, int slot, boolean selected) {
				...
				if (selected) {
					Map<String, Object> $_dependencies = new HashMap<>();
					$_dependencies.put("entity", entity);
					MjolnirToolInHandTickProcedure.executeProcedure($_dependencies);
				}
			}
