...
import net.mcreator.marvelmashup.procedures.BlasterBulletHitsBlockProcedure;
...
public class BlasterItem extends MarvelMashupModElements.ModElement {
	@ObjectHolder("marvel_mashup:blaster")
	public static final Item block = null;
	@ObjectHolder("marvel_mashup:entitybulletblaster")
	public static final EntityType arrow = null;
	public BlasterItem(MarvelMashupModElements instance) {
		super(instance, 25);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletblaster").setRegistryName("entitybulletblaster"));
	}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		protected void arrowHit(LivingEntity entity) {
			...
			World world = this.world;
			{
				...
				BlasterBulletHitsBlockProcedure.executeProcedure($_dependencies);
			}
		}
	...
	public static class CustomRender extends EntityRenderer<ArrowCustomEntity> {
		private static final ResourceLocation texture = new ResourceLocation("marvel_mashup:textures/texture.png");
	...
	public static class Modelcustom_model extends EntityModel<Entity> {
		...
		public Modelcustom_model() {
			...
			bb_main.setTextureOffset(0, 0).addBox(-3.0F, -11.0F, -3.0F, 6.0F, 6.0F, 6.0F, 0.0F, false);
		}
