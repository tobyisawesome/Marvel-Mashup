...
public class QuinjetStructure extends MarvelMashupModElements.ModElement {
	public QuinjetStructure(MarvelMashupModElements instance) {
		super(instance, 33);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 10000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("marvel_mashup", "quinjets8798251"));
						if (template == null)
							return false;
