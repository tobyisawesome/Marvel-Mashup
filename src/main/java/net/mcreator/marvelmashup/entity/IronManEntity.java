...
public class IronManEntity extends MarvelMashupModElements.ModElement {
	public static EntityType entity = null;
	public IronManEntity(MarvelMashupModElements instance) {
		super(instance, 26);
	...
	public static class CustomEntity extends MonsterEntity implements IRangedAttackMob {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			setNoAI(false);
			enablePersistence();
			this.setItemStackToSlot(EquipmentSlotType.MAINHAND, new ItemStack(BlasterItem.block, (int) (1)));
		}
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(BlasterItem.block, (int) (1)));
		}
		...
		public void onStruckByLightning(LightningBoltEntity entityLightningBolt) {
			...
			Entity entity = this;
			{
				...
				ThorItIsStruckByLightningProcedure.executeProcedure($_dependencies);
			}
		}
