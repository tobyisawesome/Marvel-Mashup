...
import net.mcreator.marvelmashup.procedures.LegendaryMjolnirBlockOnBlockRightClickedProcedure;
...
public class LegendaryMjolnirBlockBlock extends MarvelMashupModElements.ModElement {
	@ObjectHolder("marvel_mashup:legendary_mjolnir_block")
	public static final Block block = null;
	public LegendaryMjolnirBlockBlock(MarvelMashupModElements instance) {
		super(instance, 1);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("legendary_mjolnir_block");
		}
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			return VoxelShapes.create(0D, 0D, 0D, 1D, 0.688D, 1D).withOffset(offset.x, offset.y, offset.z);
		}
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				LegendaryMjolnirBlockOnBlockRightClickedProcedure.executeProcedure($_dependencies);
			}
