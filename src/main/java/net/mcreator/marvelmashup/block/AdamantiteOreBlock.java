...
import net.mcreator.marvelmashup.item.AdamantiteGemItem;
...
public class AdamantiteOreBlock extends MarvelMashupModElements.ModElement {
	@ObjectHolder("marvel_mashup:adamantite_ore")
	public static final Block block = null;
	public AdamantiteOreBlock(MarvelMashupModElements instance) {
		super(instance, 8);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(AdamantiteGemItem.block, (int) (1)));
		}
	}
	@Override
