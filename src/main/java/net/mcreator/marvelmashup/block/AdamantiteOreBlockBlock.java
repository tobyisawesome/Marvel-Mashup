...
public class AdamantiteOreBlockBlock extends MarvelMashupModElements.ModElement {
	@ObjectHolder("marvel_mashup:adamantite_ore_block")
	public static final Block block = null;
	public AdamantiteOreBlockBlock(MarvelMashupModElements instance) {
		super(instance, 9);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("adamantite_ore_block");
		}
